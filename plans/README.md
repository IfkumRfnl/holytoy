...
| 011  | Per-invocation context ABI: reentrant `ht_fp`, GLSL per-invocation global semantics, `ht_frame` uniforms | P1 | M/L | 010 | TODO |
| 012  | SMP background render task: shading off draw_it, JobQue fan-out across cores 1-3, double buffer, proof 14 | P1 | L | 011 | TODO |
| 013  | F32 semantics: bit-reproduce llvmpipe (RNE rounding + Cephes-F32 sin) to converge the hash-idiom visual FAILs | P1 | L | 011 | TODO (parallel with 012) |
