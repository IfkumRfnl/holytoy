...
| 011  | Per-invocation context ABI: reentrant `ht_fp`, GLSL per-invocation global semantics, `ht_frame` uniforms | P1 | M/L | 010 | DONE (merged `7fa12c2` 2026-07-17; 13/13 proofs incl. HT CTX OK; corpus byte-stable A 39/39 compile, 28/39 visual) |
...
| 015  | Viewport quality + scaling: bilinear corner-sample upsample, SMP=8 + band oversubscription, scene-adaptive palette, SSE stage-0 probe | P1 | L | 014 | DONE (all 4 stages merged 2026-07-18, post-merge 17/17 proofs; bilerp 1:16 == 1:1 exact on linear shaders; heavy workload 146->127 ms bilerp / 75 ms flood+oversub at 1:16; adaptive palette 5/5 spot-checks better, PAL=fixed byte-stable, gui.sh defaults adaptive; SSE sweep 10401 ops 0 mismatch, XMM task-switch-safe => packed-PS backend = plan 016 candidate; corpus A 39/39 exec, visual 32/39, all 78 V-DAT md5s byte-identical throughout) |
