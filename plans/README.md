...
| 010  | Adaptive render scale, visual-correctness oracle (committed reference DATs + `visual` reporting), Shadertoy corpus v2 (~50 shaders, texture-channel stratum measured honestly) | P1 | XL | 009 | IN PROGRESS |
