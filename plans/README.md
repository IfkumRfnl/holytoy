...
| 015  | Viewport quality + scaling: bilinear corner-sample upsample, SMP=8 + band oversubscription, scene-adaptive palette, SSE stage-0 probe | P1 | L | 014 | IN PROGRESS (A+B+D merged 2026-07-18, post-merge 16/16 proofs; bilerp 1:16 == 1:1 exact on linear shaders; temple 146->127 ms bilerp / 75 ms flood+oversub at 1:16; SSE sweep 10401 ops 0 mismatch => packed-PS = plan 016 candidate; Stage C palette executing) |
